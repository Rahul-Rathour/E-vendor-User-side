...
const ProductBanner = ({ itemsPerPageFromBanner, sortHandler }) => {
      ...
      <div className="flex items-center gap-2 md:gap-6 mt-4 md:mt-0">
        <div className="flex items-center gap-2 text-base text-[#767676] relative">
          ...
          <select
            ...
            id="sort"
            className="w-32 md:w-52 border-[1px] border-gray-200 py-1 px-4 cursor-pointer text-primeColor text-base"
          >
