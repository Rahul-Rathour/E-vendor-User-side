    ...
    <div className="max-w-container mx-auto px-4">
      ...
      <div className="pb-10">
        <h1 className="max-w-[600px] text-base text-lightText mb-2">
          ...
          brings you insights, inspiration, and trends in the world of fashion and e-commerce.
          Stay tuned with our journal for updates, guides, and behind-the-scenes stories from our creative team.
        </h1>
        <Link to="/shop">
